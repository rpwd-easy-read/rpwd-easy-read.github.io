...
Following the EquitableDocs project convention (`CLAUDE.md`, section 6.1: "Semantic HTML5 + minimal CSS + vanilla JS. No React. No Next.js. No frameworks."):
...
This is the test the app must pass before going public. Same rules as the EquitableDocs CLAUDE.md.
